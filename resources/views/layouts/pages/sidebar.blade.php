    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link {{(request()->is('sales/index*'))  ? 'active' : ''}}">
                <i class="nav-icon fas fa-th"></i>
              <p>
                Menu
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('sales.index')}}" class="nav-link {{(request()->is('sales/index*')) ? 'active' : ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sales</p>
                </a>
              </li>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
                <a href="{{route('manager.home')}}" class="nav-link {{(request()->is('manager/home') || (request()->is('home'))) ? 'active' : ''}}">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Home
                  </p>
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link {{(request()->is('manager/home*'))  ? 'active' : ''}}">
                <i class="nav-icon fas fa-th"></i>
              <p>
                Menu
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('manager.indexSales')}}" class="nav-link {{(request()->is('sales/index/sales*')) ? 'active' : ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sales</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('manager.indexPurchases')}}" class="nav-link {{(request()->is('manager/index/purchases*')) ? 'active' : ''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Purchases</p>
                </a>
              </li>
